...
public class ClassNotesBinarySearchST2<K extends Comparable<? super K>, V> {
	...
	public ClassNotesBinarySearchST2() { this(INIT_CAPACITY); }

	// create an empty symbol table with given initial capacity
	@SuppressWarnings("unchecked")
	public ClassNotesBinarySearchST2(int capacity) {
	...
	public static void main(String[] args) {
		...
		ClassNotesBinarySearchST2<String, Integer> st = new ClassNotesBinarySearchST2<>();
