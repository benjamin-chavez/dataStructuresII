...
/**
 *  The <code>IndexMaxPQ</code> class represents an indexed priority queue of generic keys.
...
public class IndexMaxPQ<K extends Comparable<? super K>> implements Iterable<Integer> {
	 ...
	 * <p>
	 * The iterator doesn't implement <code>remove()</code> since it's optional.
	 */
