 ...
 *  one bit at a time (as a <code>boolean</code>),
 *  8 bits at a time (as a <code>byte</code> or <code>char</code>),
 *  16 bits at a time (as a <code>short</code>),
 *  32 bits at a time (as an <code>int</code> or <code>float</code>), or
 *  64 bits at a time (as a <code>double</code> or <code>long</code>).
 *  <p>
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <code>BinaryIn</code> with calls
 *  to <code>In</code>; otherwise unexpected behavior will result.
 */
public final class BinaryIn {
	 ...
	 * @return the next bit of data from the binary input stream as a <code>boolean</code>
	 ...
	 * @return the next 8 bits of data from the binary input stream as a <code>char</code>
	 ...
	 * @return the next r bits of data from the binary input streamt as a <code>char</code>
	 ...
	 * @return the remaining bytes of data from the binary input stream as a <code>String</code>
	 ...
	 * @return the next 16 bits of data from the binary standard input as a <code>short</code>
	 ...
	 * @return the next 32 bits of data from the binary input stream as a <code>int</code>
	 ...
	 * @param r number of bits to read.
	 * @return the next r bits of data from the binary input stream as a <code>int</code>
	 ...
	 * @return the next 64 bits of data from the binary input stream as a <code>long</code>
	 ...
	 * @return the next 64 bits of data from the binary input stream as a <code>double</code>
	 * @throws RuntimeException if there are fewer than 64 bits available
	 */
	 ...
	 * @return the next 32 bits of data from standard input as a <code>float</code>
	 ...
	 * @return the next 8 bits of data from the binary input stream as a <code>byte</code>
	 * @throws RuntimeException if there are fewer than 8 bits available
	 */
