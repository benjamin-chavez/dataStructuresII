 ...
 *  primtive type variables (<code>boolean</code>, <code>byte</code>, <code>char</code>,
 ...
 *  <p>
 *  The client must <code>flush()</code> the output stream when finished writing bits.
 *  <p>
 *  The client should not intermixing calls to <code>BinaryOut</code> with calls
 *  to <code>Out</code>; otherwise unexpected behavior will result.
 */
public final class BinaryOut {
	...
	/**
	 * Write the specified bit to the binary output stream.
	 * @param x the <code>boolean</code> to write.
	 */
	...
	/**
	 * Write the 8-bit byte to the binary output stream.
	 * @param x the <code>byte</code> to write.
	 */
	 ...
	 * @throws RuntimeException if <code>r</code> is not between 1 and 32.
	 * @throws RuntimeException if <code>x</code> is not between 0 and 2<sup>r</sup> - 1.
	 */
	 ...
	 * @param x the <code>double</code> to write.
	 */
	 ...
	 * @param x the <code>float</code> to write.
	 */
	 ...
	 * @param x the <code>short</code> to write.
	 */
	 ...
	 * @param x the <code>char</code> to write.
	 * @throws RuntimeException if <code>x</code> is not betwen 0 and 255.
	 */
	 ...
	 * @param x the <code>char</code> to write.
	 * @param r the number of relevant bits in the char.
	 * @throws RuntimeException if <code>r</code> is not between 1 and 16.
	 * @throws RuntimeException if <code>x</code> is not between 0 and 2<sup>r</sup> - 1.
	 */
